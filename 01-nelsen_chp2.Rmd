...
The H-volume for $H(x,y)=\max(x,y)$ is `r H1_vol(c(0,1),c(0,1))`, so this function is *not* 2-increasing. This is text that refers to Figure \@ref(fig:ex2-1pltb)

```{r ex2-1plta, fig.cap="Contour plot", fig.align="center", cache=TRUE}
contour(x,y,z1)
```

```{r ex2-1pltb, fig.cap="Color image", fig.align="center", cache=TRUE}
...
```{r ex2-3pltc, include=FALSE, cache=TRUE}
